...
$(document).ready(function () {
  ...
  $("#btnGravar").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var id, name, description, _error$response, errorMessage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          id = $("#txtId").val(); // Captura o ID
          name = $("#txtName").val();
        ...
        case 19:
          ...
          alert(errorMessage);
          console.error("Erro ao enviar a requisição:", _context.t0);
        case 24:
        case "end":
...
function _loadTable() {
  _loadTable = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, table, _error$response2;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.get(url + 'category');
        case 3:
          response = _context2.sent;
          table = new DataTable('#tbCategory', {
            data: response.data,
            columns: [{
              data: 'id'
            }, {
        ...
        case 8:
          ...
          alert("Erro ao carregar categorias: " + (((_error$response2 = _context2.t0.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _context2.t0.message));
        case 11:
        case "end":
...
function _loadCategory() {
  _loadCategory = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    var response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.get(url + 'category/' + id);
        case 3:
        ...
        case 9:
          ...
          console.error("Erro ao carregar a categoria:", _context3.t0);
        case 12:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 1;
          _context4.next = 4;
          return _axios.default.delete(url + 'category/' + id);
        case 4:
        ...
        case 8:
          ...
          console.error("Erro ao excluir a categoria:", _context4.t0);
          alert("Erro ao excluir a categoria: " + (((_error$response3 = _context4.t0.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.message) || _context4.t0.message));
        case 12:
        case "end":
