...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/web/js/supply.js":[function(require,module,exports) {
"use strict";
...
$("#btnGravar").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, user, supplierName, contactEmail, deliveryDate, quantity, unitPrice, orderStatus, payload, _error$response, errorMessage;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 11:
        ...
        _context.next = 16;
        return _axios.default.post(url + 'supply', payload);
      case 16:
      ...
      case 19:
        _context.next = 21;
        return _axios.default.put(url + 'supply/' + id, payload);
      case 21:
      ...
      case 25:
        ...
        errorMessage = ((_error$response = _context.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || "Erro durante a gravação. Tente novamente.";
        alert(errorMessage);
      case 29:
      case "end":
  ...
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.prev = 0;
        _context2.next = 3;
        return _axios.default.get(url + 'users');
      case 3:
        response = _context2.sent;
        $.each(response.data, function (key, item) {
          $('#ddlUser').append($("<option></option>").attr("value", item.id).text(item.name));
        });
        loadTable();
        _context2.next = 11;
        break;
...
function loadTable() {
  _axios.default.get(url + 'supply').then(function (response) {
    var table = new DataTable('#tbSupply', {
      data: response.data,
      columns: [{
        data: 'id'
      }, {
...
function loadSupply(_x) {
  return _loadSupply.apply(this, arguments);
}
function _loadSupply() {
  _loadSupply = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    var response, _response$data$user, _error$response2;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 4;
          return _axios.default.get(url + 'supply/' + id);
        case 4:
          response = _context3.sent;
          console.log("Resposta da API:", response);
          if (response.data && response.data.id) {
            $("#txtId").val(response.data.id);
            $("#ddlUser").val(((_response$data$user = response.data.user) === null || _response$data$user === void 0 ? void 0 : _response$data$user.id) || '');
        ...
        case 9:
          ...
          console.error("Erro ao carregar fornecedor: ", _context3.t0);
          alert("Erro ao carregar fornecedor: " + (((_error$response2 = _context3.t0.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || _context3.t0.message));
        case 13:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _axios.default.delete(url + 'supply/' + id);
        case 3:
        ...
        case 7:
          ...
          console.error("Erro ao excluir fornecedor: ", _context4.t0);
          alert("Erro ao excluir fornecedor: " + (((_error$response3 = _context4.t0.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.message) || _context4.t0.message));
        case 11:
        case "end":
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/web/js/supply.js"], null)
//# sourceMappingURL=/supply.cb304d59.js.map