...
$("#btnGravar").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, name, description, price, category, _error$response;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 12:
        _context.next = 14;
        return _axios.default.put(url + 'product/' + id, {
          name: name,
          description: description,
          price: price,
          category: {
...
$(document).ready(function () {
  ...
  _axios.default.get(url + 'category').then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddlCategory').append($("<option></option>").attr("value", item.id).text(item.name) // Exibe o nome da categoria
      );
    });
  }).catch(function (error) {
    var _error$response2;
    alert("Erro ao carregar categorias: " + (((_error$response2 = error.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || error.message));
  });
  loadTable();
});
function loadTable() {
...
function _loadProduct() {
  _loadProduct = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
      ...
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return _axios.default.delete(url + 'product/' + id).then(function (response) {
            ...
            alert("Erro ao excluir o produto: " + (((_error$response4 = error.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message) || error.message));
          });
        case 4:
        case "end":
