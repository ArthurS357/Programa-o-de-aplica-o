...
$("#btnGravar").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, user, product, client, quantity, _error$response;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      ...
      case 21:
        ...
        alert("Erro durante a gravação: " + (((_error$response = _context.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _context.t0.message));
      case 24:
      case "end":
...
$(document).ready(function () {
  ...
  _axios.default.get(url + 'users').then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddlUser').append($("<option></option>").attr("value", item.id).text(item.name) // Exibe o nome do usuário
      );
    });
  }).catch(function (error) {
    var _error$response2;
    alert("Erro ao carregar usuários: " + (((_error$response2 = error.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || error.message));
  });

  // Carregar produtos
  _axios.default.get(url + 'product').then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddlProduct').append($("<option></option>").attr("value", item.id).text(item.name) // Exibe o nome do produto
      );
    });
  }).catch(function (error) {
    var _error$response3;
    alert("Erro ao carregar produtos: " + (((_error$response3 = error.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.message) || error.message));
  });

  // Carregar clientes
  _axios.default.get(url + 'client').then(function (response) {
    $.each(response.data, function (key, item) {
      $('#ddlClient').append($("<option></option>").attr("value", item.id).text(item.name) // Exibe o nome do cliente
      );
    });
  }).catch(function (error) {
    var _error$response4;
    alert("Erro ao carregar clientes: " + (((_error$response4 = error.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message) || error.message));
  });
  loadTable();
});
function loadTable() {
  _axios.default.get(url + 'sale', {}).then(function (response) {
    ...
    alert("Erro ao carregar vendas: " + (((_error$response5 = error.response) === null || _error$response5 === void 0 || (_error$response5 = _error$response5.data) === null || _error$response5 === void 0 ? void 0 : _error$response5.message) || error.message));
  });
}
function loadSale(_x) {
  return _loadSale.apply(this, arguments);
}
function _loadSale() {
  _loadSale = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
