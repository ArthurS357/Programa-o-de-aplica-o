...
$("#btnGravar").click(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var id, name, description, cpf, address, fone, _error$response, errorMessage;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        id = $("#txtId").val(); // Obtenha o ID aqui
        name = $("#txtName").val();
      ...
      case 22:
        ...
        alert(errorMessage);
        console.error("Erro ao enviar a requisição:", _context.t0); // Log do erro
      case 27:
      case "end":
...
function loadTable() {
  _axios.default.get(url + 'client').then(function (response) {
    ...
    alert("Erro ao carregar clientes: " + (((_error$response2 = error.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message) || error.message));
  });
}
function loadClient(_x) {
  return _loadClient.apply(this, arguments);
}
function _loadClient() {
  _loadClient = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
