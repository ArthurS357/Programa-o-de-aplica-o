  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        profile = $("#ddlProfile option:selected").val();
        _context.prev = 6;
        if (id) {
          _context.next = 13;
          break;
  ...
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.prev = 0;
        _context2.next = 3;
        return _axios.default.get(url + 'profile');
      case 3:
        response = _context2.sent;
        $.each(response.data, function (key, item) {
          $('#ddlProfile').append($("<option></option>").attr("value", item.id).text(item.name));
        });
        loadTable();
        _context2.next = 11;
        break;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.get(url + 'users/' + id);
        case 3:
        ...
        case 10:
          ...
          alert("Erro ao carregar os dados do Usurio: " + _context3.t0.message);
        case 13:
        case "end":
